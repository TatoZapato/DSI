 ...
 * @author Führer
 */
public class IngresarFuncionSitio extends javax.swing.JFrame {

    /**
     * Creates new form IngresarFuncionSitio
     */
    public IngresarFuncionSitio() {
        initComponents();
        setLocationRelativeTo(null);
    }

    public IngresarFuncionSitio(MantenedorFuncionSitio father) {
        initComponents();
        setLocationRelativeTo(null);
    ...
    private MantenedorFuncionSitio padreMantenedor = null;
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        if (!txtFuncion.getText().equals("")) {
            if (padreMantenedor != null) {
                ...
                try {
                    FuncionSitioDAO.insertarFuncion(txtFuncion.getText());
                    dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IngresarFuncionSitio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IngresarFuncionSitio().setVisible(true);
            }
        });
    }
