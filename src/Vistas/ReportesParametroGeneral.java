...
public class ReportesParametroGeneral extends javax.swing.JFrame {
    ...
    public ReportesParametroGeneral() {
        ...
        try {
            llenarTablaInventarios(ParametroGeneralDAO.getAllParametroGeneral());
        } catch (DAOException ex) {
            Logger.getLogger(ReportesParametroGeneral.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void llenarTablaInventarios(LinkedList<ParametroGeneral> lista) {
